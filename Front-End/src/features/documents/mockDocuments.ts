...
export const mockDocuments: DocumentSummary[] = [
  {
    ...
    title: 'Launch plan',
    summary:
      'Cross-functional draft for release milestones, owner handoff, and collaborative review.',
  ...
  },
  {
    ...
    summary:
      'Living note for editor UX feedback, import gaps, and backend contract follow-ups.',
