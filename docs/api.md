...
- snapshot restore source는 현재 `SNAPSHOT_STORE=file|flash_kv|blockbucket|grebedb|highlandcows_isam|simple_db|docdb|eight|epoch_db|rumdb|shorterdb|sqlite|heed|hightower_kv|hmdb|icefalldb|bitask|bitkv_rs|candystore|cuendillar|jammdb|mace|fjall|persy|persistent_kv|native_db|nebari|nikidb|nodb|okofdb|parity_db|pickledb|rcask|microkv|redb|rskey|readb|rustlite|rustcask|rusty_leveldb|canopydb|caves|ckydb|scdb|skv|surrealkv|sled|rustbreak|yedb|btree_store|siamesedb|structsy|abyssiniandb|aeternusdb|thunderdb|thetadb|tinybase|dblite|dbless|db_rs|dharmadb|sanakirja|snaildb|tinykv|yakv|saberdb|smolldb|jsondb|kopperdb|kv|koit|lite_db|lsm_storage_engine|jfs|json_store|s3|managed` 중 하나다.
